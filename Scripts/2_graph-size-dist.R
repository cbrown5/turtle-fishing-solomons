...
ggsave("Shared/Outputs/size-dist-by-spp.png", gsizes,
       width = 3, height = 3)
...
ggsave("Shared/Outputs/size-dist-by-region.png", gsizes_region,
       width = 6, height = 6)
...
ggsave("Shared/Outputs/size-dist-plots.png", gboth,
       width = 12, height = 4)
